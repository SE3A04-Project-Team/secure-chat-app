...
class FirebaseMessageDatabase(MessageDatabase):
    ...
    class FirebaseRoomFunctions(MessageDatabase.DatabaseRoomFunctions):
    ...
    class FirebaseMessageFunctions(MessageDatabase.DatabaseMessageFunctions):
    ...
    class FirebaseUserFunctions(MessageDatabase.DatabaseUserFunctions):
    ...
    class FirebaseContactFunction(MessageDatabase.DatabaseContactFunction):
